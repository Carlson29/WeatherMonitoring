...
public class Stimulator3 {
    public static void main(String[] args) {
        try {
            ...
            String weatherObjectLabel = "/Sensor3";
            Naming.rebind(registryURL + weatherObjectLabel + "", sensor3);
            while (true) {
                Weather w = sensor3.getWeather();
                sensor3.addWeather(w);
                Thread.sleep(200);
            }
        } catch (
                RemoteException ex) {
